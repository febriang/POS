                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#delete<?=$idmasuk;?>">
                                                Delete
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="hapusbarangmasuk">Enter</button>
                                        ...
                                        <div class="modal fade" id="edit<?=$idmasuk;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        <input type="text" name="namaproduk" value="<?=$namaproduk;?>" class="form-control mb-3" placeholder="Nama Produk" disabled>  
                                                        <input type="text" name="deskripsi" value="<?=$deskripsi;?>" class="form-control mb-3" placeholder="Deskripsi" disabled>   
                                                        <input type="number" name="qty" value="<?=$qty;?>" class="form-control mb-3" placeholder="Jumlah Produk">  
                                                        <input type="hidden" name="idm" value="<?=$idmasuk;?>">
                                                        <input type="hidden" name="idp" value="<?=$idproduk;?>">
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="editbarangmasuk">Enter</button>
                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                    </div>
                                                </form>
                                                </div>
                ...
                <div class="modal-body">
                    ...
                    <select name="idproduk" class="form-control">
                        <?php
                            ...
                            while($x = mysqli_fetch_array($getproduk)){
                                $stock = $x['stock']; 
                                $namaproduk = $x['namaproduk'];
                                $deskripsi = $x['deskripsi'];
                                $idproduk = $x['idproduk'];
                        ...
                        <option value = "<?=$idproduk;?>">
                            <?=$namaproduk;?> - <?=$deskripsi;?> (Stok: <?=$stock?>)
                        </option>
                    ...
                    <input type="number" name="qty" class="form-control mt-4" placeholder="Jumlah" min="1" required></input>
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="barangmasuk">Enter</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                </div>
            </form>
            </div>
