<?php
    ...
    $jp1 = mysqli_query($koneksi, "select * from pesanan");
    $jp2 = mysqli_num_rows($jp1); //jumlah pesanan
?>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Pesanan : <?=$jp2;?></div>
                                </div>
                            </div>
                        </div>
                        <!-- tambah -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$jumlah;?></td>
                                                <td>
                                                    <a href="view.php?idp=<?=$idorder;?>" class="btn btn-primary">Detail</a>
                                                    <button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#delete<?=$idorder;?>">
                                                          Delete
                                                    </button>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="hapuspesanan">Enter</button>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <select name="idpelanggan" class="form-control">
                        <?php
                            ...
                            while($x = mysqli_fetch_array($getpelanggan)){
                                $idpelanggan = $x['idpelanggan'];
                                $namapelanggan = $x['namapelanggan'];
                                $alamat = $x['alamat'];
                        ?>
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="tambahpesanan">Enter</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                </div>
            </form>
            </div>
